...
class drt_sfc_2d:
    ...
    def pre_drt_2d_sfc(self):
        ...
        if ('lambertian' in self.sfc.data['sfc']['name'].lower()):
            ...
            self.nml['header'] = dict(data='L', name='Header for DISORT Surface File', units='N/A')
            ...
            self.nml['header'] = dict(data='J', name='Header for DISORT Surface File', units='N/A')
            self.sfc_data = self.sfc.data['sfc']['data']
            ...
            self.nml['header'] = dict(data='T', name='Header for DISORT Surface File', units='N/A')
            self.sfc_data = self.sfc.data['sfc']['data']
            ...
            self.nml['header'] = dict(data='O', name='Header for DISORT Surface File', units='N/A')
            self.sfc_data = self.sfc.data['sfc']['data']
            ...
            self.nml['header'] = dict(data='X', name='Header for DISORT Surface File', units='N/A')
            self.sfc_data = self.sfc.data['sfc']['data']
