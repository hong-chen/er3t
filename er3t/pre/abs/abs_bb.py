...
class abs_rrtmg_sw:
    ...
    def load_data(self):
        ...
        # wavelength
        #/----------------------------------------------------------------------------\#
        wvln_min = f0.variables['BandWavenumberLowerLimit'][:][self.iband]
        wvln_max = f0.variables['BandWavenumberUpperLimit'][:][self.iband]
        ...
        # Gs
        #/----------------------------------------------------------------------------\#
        Ng = f0.variables['NumGPoints'][:][:, self.iband]
        print(f0.variables['NumGPoints'][:])
        # print(Ng)
        #\----------------------------------------------------------------------------/#
