...
def grid_modis_by_extent(lon, lat, data, extent=None, NxNy=None, method='nearest'):
    ...
    How to use:
        ...
        lon, lat data = grid_modis_by_extent(lon0, lat0, data0, extent=[10, 15, 10, 20])
    """
...
def grid_modis_by_lonlat(lon, lat, data, lon_1d=None, lat_1d=None, method='nearest'):
    ...
    How to use:
        After read in the longitude latitude and data into lon0, lat0, data0
        lon, lat data = grid_modis_by_lonlat(lon0, lat0, data0, lon_1d=np.linspace(10.0, 15.0, 100), lat_1d=np.linspace(10.0, 20.0, 100))
    """
...
def download_modis_https(
    ...
    try:
        ...
        app_key = 'EA7C812A-B2E1-11E8-BB0D-DEF50DDD974A'
        if verbose:
