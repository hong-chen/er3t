...
def plot_flux3d(i, iz):
    ...
    if plot:
        ...
        ax1.plot_surface(xx, yy, zz, facecolors=colors, shade=False, rstride=1, cstride=1, zorder=0)
        #╰────────────────────────────────────────────────────────────────────────────╯#
        ...
        norm = mcolors.Normalize(vmin=0.0, vmax=0.8)
        colors = cmap(norm(flux), alpha=0.1)
        ax1.plot_surface(xx, yy, zz, facecolors=colors, shade=False, rstride=1, cstride=1, zorder=1)
        #╰────────────────────────────────────────────────────────────────────────────╯#
        ...
        norm = mcolors.Normalize(vmin=0.0, vmax=0.8)
        colors = cmap(norm(flux), alpha=0.1)
        ax1.plot_surface(xx, yy, zz, facecolors=colors, shade=False, rstride=1, cstride=1, zorder=2)
        #╰────────────────────────────────────────────────────────────────────────────╯#
