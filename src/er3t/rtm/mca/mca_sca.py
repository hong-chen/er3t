...
class mca_sca:
    ...
    def pre_mca_sca(self, nskip=0, nanci=0):
        ...
        self.nml["Sca_npf"] = dict(
            data=self.pha.data["pha"]["data"].shape[1],
            name="Number of tabulated phase functions",
            units="N/A",
        )
        self.nml["Sca_nskip"] = dict(
            data=nskip, name="Number of phase functions to be skipped", units="N/A"
        )
        self.nml["Sca_nanci"] = dict(
            data=nanci, name="Number of ancillary data", units="N/A"
        )
        self.nml["Sca_nangi"] = dict(
            data=self.pha.data["ang"]["data"].size, name="Number of angles", units="N/A"
        )
