...
class func_ref_vs_cot:
    ...
    def run_all(self):
        ...
        for cot0 in self.cot:
            self.run_one(
                cot0, self.cer0, cbh0=self.cbh0, cth0=self.cth0, atm0=self.atm0
            )
    ...
    def run_one(self, cot0, cer0, cbh0=1.0, cth0=2.0, atm0=None):
        ...
        atm1d0.add_mca_1d_atm(
            ext1d=ext0, omg1d=ssa0, apf1d=asy0, z_bottom=cbh0, z_top=cth0
        )
