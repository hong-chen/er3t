...
def gen_ice_file_from_nc(
    ...
    if True:
        ...
        with open(fname, "w") as f:
            ...
            f.write(
                f" {rho.mean():.3f}  I   particle density (g/cm^3) and type (Water, Ice, Aerosol)\n"
            )
            ...
            f.write(
                f"  {reff.size:d}    {reff[0]:.3f}   {reff[-1]:.3f}  number, starting, ending effective radius\n"
            )
