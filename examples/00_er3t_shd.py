...
def example_01_rad_atm1d_clear_over_ocean(
        wavelength=550.0,
        solver='IPA',
        overwrite=True,
        plot=True
    ...
    levels = np.append(np.arange(0.0, 1.2, 0.1), np.arange(1.0, 20.1, 1.0))
...
def example_02_rad_atm1d_clear_over_land(
        wavelength=550.0,
        solver='IPA',
        overwrite=True,
        plot=True
...
if __name__ == '__main__':
    ...
    # radiance simulation
    #╭────────────────────────────────────────────────────────────────────────────╮#
    example_01_rad_atm1d_clear_over_ocean()
    example_02_rad_atm1d_clear_over_land()
