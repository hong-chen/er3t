...
def test_flux_01_clear_sky(
        fdir='tmp-data/00_er3t_mca/test_flux_01_clear_sky',
        wavelength=650.0,
        solver='3D',
        overwrite=True,
        plot=True
    ...
    # ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    if plot:
        fname_png = '00_er3t_mca-test_flux_01_%s.png' % solver.lower()
...
def test_flux_02_les_cloud_3d(
        fdir='tmp-data/00_er3t_mca/test_flux_02_les_cloud_3d',
        wavelength=650.0,
        solver='3D',
        overwrite=True,
        plot=True
    ...
    if plot:
        z_index = 4
        fname_png = '00_er3t_mca-test_flux_02_%s.png' % solver.lower()
...
def test_flux_03_les_cloud_3d_aerosol_1d(
        fdir='tmp-data/00_er3t_mca/test_flux_03_les_cloud_3d_aerosol_1d',
        wavelength=650.0,
        solver='3D',
        overwrite=True,
        plot=True
    ...
    """
    Similar to test_flux_02 but adding an aerosol layer above LES clouds
    ...
    if plot:
        z_index = 4
        fname_png = '00_er3t_mca-test_flux_03_%s.png' % solver.lower()
...
if __name__ == '__main__':
    ...
    # test_flux_02_les_cloud_3d()

    test_flux_03_les_cloud_3d_aerosol_1d()
